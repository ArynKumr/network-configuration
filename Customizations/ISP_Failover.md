...
Example:
    - ping -I enp44s0 8.8.8.8 

# ISP Failover Using fwmark-Based Policy Routing

1. Prerequisites: Supporting Pieces


    To make this work, you must also have:
...
1. Goal: Ensure that traffic marked for ISP-1 (`fwmark 0x00<isp1_mark>0000/0x00ff0000`) is automatically rerouted via ISP-2 when ISP-1 becomes unavailable — without changing nftables rules or user marks.
